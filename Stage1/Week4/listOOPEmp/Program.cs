        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if (userChoiceString == "O" || userChoiceString == "o")
                {
                    ...
                    // TODO: read in txt file, use ReadLine() to read in 1 line at a time, check 3rd entry 'S', create object, save object in 1d treat listOfEmployees array.
                    index = 0;
                    using (StreamReader sr = File.OpenText(inputFileName))
                    {
                        ...
                        while ((LastNameString = sr.ReadLine()) != null)
                        {
                            ...
                            {
                                listOfEmployees.Add(new SalaryEmployee(LastNameString, FirstNameString, EmployeeTypeString, AmountString));
                            }
                            else
                            {
                                listOfEmployees.Add(new HourlyEmployee(LastNameString, FirstNameString, EmployeeTypeString, AmountString));
                            }
                            index++;
                        }
                    }
                ...
                else if (userChoiceString == "S" || userChoiceString == "s")
                {
                    ...
                    {
                        for (index = 0; index < listOfEmployees.Count; index++)
                        {
                            if (listOfEmployees[index].LastName != null)
                            {
                                sw.WriteLine(listOfEmployees[index].LastName);
                                sw.WriteLine(listOfEmployees[index].FirstName);
                                sw.WriteLine(listOfEmployees[index].EmployeeType);

                                // struggeling with this portion...
                                    if (listOfEmployees[index].EmployeeType == "S")
                                    {
                                        sw.WriteLine(listOfEmployees[index].AnnualSalary);
                                    }
                                    else
                                    {
                                        sw.WriteLine(listOfEmployees[index].HourlyRate);
                                    }
                            }
                        } // end for-loop
                    }
                ...
                else if (userChoiceString == "R" || userChoiceString == "r")
                {
                    ...
                    */
                    for (index = 0; index < listOfEmployees.Count; index++)
                    {
                        ...
                        {
                            Console.Write(listOfEmployees[index]);
                            Console.WriteLine();
                        }
                    } // end for-loop
                } // end else if R
                ...
                else if (userChoiceString == "U" || userChoiceString == "u")
                {
                    ...
                    {
                        if (((listOfEmployees[index].LastName) != LastNameString) || ((listOfEmployees[index].FirstName) != FirstNameString))
                        {
                        ...
                        else
                        {
                            if (itemFoundBool == false)
                            {
                                ...
                                Console.WriteLine($"'Found at index '{index}', employee '{listOfEmployees[index].LastName}'");
                                ...
                                if (EmployeeTypeString == "S")
                                {
                                    ...
                                    listOfEmployees[index] = tempObject;
                                }
                                else
                                {
