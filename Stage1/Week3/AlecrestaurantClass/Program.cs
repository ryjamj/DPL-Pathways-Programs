...
namespace restaurantAPP
{
  class Program
  {
    ...
    {
      Console.WriteLine("------------- test the first constructor for Restaurant -------------");
      ...
      // FineDining class
      Console.WriteLine("------------- FineDining class -------------");
      ...
      // FastFood class
      Console.WriteLine("------------- FastFood class -------------");
      // test the inheritance with default constructor
      ...
      Console.WriteLine("Mixing Restaurant and FineDining and FastFood objects in the array.");
      for (int index = 0; index < restaurantArray.Length; index++)
      {
        if (!(((restaurantArray[index]).getName()) == null))
          Console.WriteLine(restaurantArray[index]);
